...
class QuotesSpider(scrapy.Spider):
    name = "quotes"
    custom_settings = {
        "FEEDS": {"qoutes.json": {"format": "json", "encoding": "utf8", "overwrite": True}}
    }
...
class AuthorsSpider(scrapy.Spider):
    name = "authors"
    custom_settings = {
        "FEEDS": {"authors.json": {"format": "json", "encoding": "utf8", "overwrite": True}}
    }
    start_urls = ["http://quotes.toscrape.com/"]
    visited_authors = set()
...
def load_data_to_mongo():
    """Завантажує зібрані дані в MongoDB"""
